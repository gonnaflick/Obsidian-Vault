...
Con el resultado obtenido, se debe calcular la cantidad de potencia que consumirían 20 computadoras, suponiendo que tengan el mismo consumo que la computadora medida.
...
El objetivo de esta medición es analizar el consumo de energía de una computadora en distintos escenarios de uso, con el fin de tener una idea hipotética del consumo que tendrían un conjunto de computadoras en un centro de cómputo  para realizar un analisis al respecto.
```ad-warning
...
![Engelbart|500](voltaje_sin_regular.jpg)
Voltaje sin regular
![Engelbart|200](voltaje_regulado.jpg)
```
